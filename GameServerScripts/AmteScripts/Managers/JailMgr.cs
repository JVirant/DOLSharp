...
namespace DOL.GS.Scripts
{
	...
	public static class JailMgr
	{
		...
		private static void Emprisonner(GamePlayer player, int cost, DateTime sortie, string GM, bool JailRP, string raison)
		{
			...
			if (JailRP)
				player.Out.SendMessage("Vous avez été mis en prison pour vos actes par "+ GM +". Votre caution s'éleve à "+cost+" Or. Pour sortir, demandez à quelqu'un de payer votre caution a Stronghold, le gardien de la prison.",eChatType.CT_Important,eChatLoc.CL_SystemWindow);
        ...
        /// <summary>
        /// Donne l'entré dans la base du prisonnier par son nom
        /// </summary>
        /// <param name="Name">Nom du prisonnier</param>
