...
namespace DOL.GS.Spells
{
	...
	public class UniPortal : SpellHandler
	{
		...
		public override void ApplyEffectOnTarget(GameLiving target, double effectiveness)
		{
			...
			{
				player.Out.SendMessage(LanguageMgr.GetTranslation(player.Client.Account.Language, "GameObjects.GamePlayer.UseSlot.CantUseInCombat"), eChatType.CT_System, eChatLoc.CL_SystemWindow);
				return;
			}
