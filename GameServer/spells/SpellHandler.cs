...
//			}
		...
		public virtual int CalculateToHitChance(GameLiving target)
		{
			...
			{
				hitchance -= (int)(m_caster.GetConLevel(target) * Properties.PVE_SPELL_CONHITPERCENT);
				hitchance += Math.Max(0, target.Attackers.Count - 1) * Properties.MISSRATE_REDUCTION_PER_ATTACKERS;
			}
