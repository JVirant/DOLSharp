...
namespace DOL.GS.Commands
{
	[CmdAttribute(
		"&account",
		ePrivLevel.Admin,
		"Commands.Admin.Account.Description",
        "Commands.Admin.Account.Usage.Create",
		"Commands.Admin.Account.Usage.ChangePassword",
		"Commands.Admin.Account.Usage.Delete",
		"Commands.Admin.Account.Usage.DeleteChar",
		"Commands.Admin.Account.Usage.MoveChar",
        "Commands.Admin.Account.Usage.Status",
        "Commands.Admin.Account.Usage.UnBan",
        "Commands.Admin.Account.Usage.AccountName")]
                ...
                case "create":
                    {
                        ...
                        foreach (char c in AccountName.ToCharArray())
                        {
                            if ((c < '0' || c > '9') && (c < 'a' || c > 'z'))
                            {
                                DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.InvalidAccountName"));
                                return;
                            }
                        }
                        ...
                        {
                            DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.InvalidAccountNameOrPassword"));
                            return;
                        }
                        ...
                        if (account != null)
                        {
                            DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.AccountNameAlreadyRegistered"));
                            return;
                        }
                        ...
                        DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.AccountCreated"));
                    }
                    break;
                #endregion Create
				...
				case "changepassword":
					{
						...
						if (acc == null)
						{
							DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.AccountNotFound", accountname));
							return;
						}
				...
				case "delete":
					{
                        ...
                        DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.AccountDeleted", acc.Name));
						return;
					}
				#endregion Delete
                ...
                case "deletecharacter":
                    {
                        ...
                        if (cha == null)
                        {
                            DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.CharacterNotFound", charname));
                            return;
                        }
                        ...
                        DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.CharacterDeleted", cha.Name));
                        return;
                    }
                ...
                case "movecharacter":
                    {
                        ...
                        switch ((eRealm)cha.Realm)
                        {
                            ...
                            case eRealm.Hibernia:
                                ...
                                break;
                            default:
                                DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.CharNotFromValidRealm"));
                                return;
                        }
                        ...
                        if (freeslot == 0)
                        {
                            DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.AccountHasNoFreeSlots", accountname));
                            return;
                        }
                        ...
                        DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.CharacterMovedToAccount", cha.Name, acc.Name));
                        return;
                    }
                ...
                case "accountname":
                    {
                        ...
                        DisplayMessage(client, LanguageMgr.GetTranslation(client.Account.Language, "Commands.Admin.Account.AccNameForChar", Char.Name, AccName));
